...
Read [OCI_Console-Connections](https://github.com/Olygo/OCI_Console-Connections) to learn how to troubleshoot Linux and Windows instances using OCI Console Connections. 
